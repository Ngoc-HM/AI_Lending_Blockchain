...
def create_db_from_text():
    ...
    text_splitter = CharacterTextSplitter(
        separator="\n", # xuống doòng để chia ra
        chunk_size=612, # mỗi đoạn text thì có độ dài bao nhiêu ? 512 Kí tụ
        chunk_overlap=100, # nếu cắt text thì sẽ bị riêng lẻ nên sẽ c text ghép của 2 đoạn
        length_function=len # độ dài của text

    )
    # chia đoạn text ra thành các đoạn text
